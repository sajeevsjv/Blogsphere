...
const Footer = () => {
  return (
    <footer className="relative overflow-hidden border-t border-violet-500/20 bg-slate-950 py-14 text-slate-400">
      <div
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
          <div>
            <h4 className="mb-4 bg-gradient-to-r from-violet-300 via-fuchsia-300 to-cyan-300 bg-clip-text text-sm font-bold uppercase tracking-widest text-transparent">
              BlogSphere
            </h4>
            <p className="text-sm leading-relaxed text-slate-400">
              Long-form stories, hot takes, and chill reads — light mode or dark, your eyes stay happy.
            </p>
          </div>

          <div>
            <h4 className="mb-4 text-sm font-bold uppercase tracking-widest text-slate-300">Links</h4>
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/blogs" className="font-medium transition hover:text-fuchsia-300">
                  Feed
                </Link>
              </li>
              <li>
                <Link to="/about" className="transition hover:text-fuchsia-300">
                  About
                </Link>
              </li>
              <li>
                <Link to="/contact" className="transition hover:text-fuchsia-300">
                  Contact
                </Link>
              </li>
              <li>
                <Link to="/privacy" className="transition hover:text-fuchsia-300">
                  Privacy
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h4 className="mb-4 text-sm font-bold uppercase tracking-widest text-slate-300">Socials</h4>
            <div className="flex flex-wrap gap-3">
              <a
                href="https://facebook.com"
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-800/80 text-slate-300 transition hover:scale-110 hover:bg-violet-600 hover:text-white"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-800/80 text-slate-300 transition hover:scale-110 hover:bg-sky-500 hover:text-white"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-800/80 text-slate-300 transition hover:scale-110 hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-500 hover:text-white"
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="my-10 h-px w-full bg-gradient-to-r from-transparent via-violet-500/40 to-transparent" />

        <div className="text-center text-xs text-slate-500">
          <p>&copy; {new Date().getFullYear()} BlogSphere. Built for readers who get it.</p>
        </div>
      </div>
    </footer>
  );
